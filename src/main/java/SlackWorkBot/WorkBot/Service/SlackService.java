...
public class SlackService {
    ...
    public void sendEphemeralMessageToUser(String channelId, String userId, String content) {
        HttpHeaders headers = getSlackHeaders(slackToken);
        try {
            String body = getJsonBody(channelId, userId, content);
    ...
    private String getJsonBody (String channelId, String userId, String text) throws JsonProcessingException {
        Map<String, String> jsonObject = new HashMap<>();
        jsonObject.put("channel", channelId);
